...
const Footer = () => {
  ...
  return (
    <footer className="bg-linear-to-br from-white via-purple-50 to-purple-100 text-gray-700 font-sans border-t-4 border-purple-600 relative overflow-visible">
